...
<form role="form" class="form-horizontal col-sm-7 col-sm-offset-2" action="<?php e::url('/user/register');?>" method="POST">
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input class="form-control" id="username" name="username" type="text" placeholder="<?php echo(__('user.register.3_to_15')); ?>"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label" for="nick"><?php echo(__('user.register.nick')); ?></label>
        <div class="col-sm-8">
            <input class="form-control" name="nick" id="nick" type="text" placeholder="<?php echo(__('user.register.max_10')); ?>"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label" for="password"><?php echo(__('user.register.password')); ?></label>
        <div class="col-sm-8">
            <input class="form-control" id="password" name="password" type="password" placeholder="<?php echo(__('user.register.min_6')); ?>"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label" for="confirm"><?php echo(__('user.register.confirm')); ?></label>
        <div class="col-sm-8">
            <input class="form-control" id="confirm" name="confirm" type="password" placeholder="<?php echo(__('user.register.required')); ?>"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label" for="school"><?php echo(__('user.register.school')); ?></label>
        <div class="col-sm-8">
            <input class="form-control" name="school" id="school" type="text" placeholder="<?php echo(__('user.register.max_30')); ?>"/>
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-4 control-label" for="email"><?php echo(__('user.register.email')); ?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="col-sm-4 control-label"><?php echo(__('user.register.captcha')); ?></label>
        <div class="col-sm-8">
